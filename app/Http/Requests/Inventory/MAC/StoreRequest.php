...
namespace App\Http\Requests\Inventory\MAC;
...
class StoreRequest extends FormRequest
{
     ...
     *
     * Note: Also see App\Http\Requests\Circuits\MACRequest
     *
     * @return array
     */
    ...
    {
        return [
            'FinalCreditAmount.regex' => 'The Final Credit Amount must be a valid amount with no commas.',
        ];
    }
}