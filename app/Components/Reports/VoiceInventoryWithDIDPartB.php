 ...
 */
class VoiceInventoryWithDIDPartB extends AbstractReport
{
    /**
     * @var string
     */
    protected $storedProcedure = 'spACOE_RptInventoryLocalWithDID_Part_B';
    ...
    {
        $this->identify(false, self::CATEGORY_INVENTORY, 'Voice Inventory with DID Part B', 71);
    }
