 ...
 */
class VoiceInventory extends AbstractReport
{
    /**
     * @var string
     */
    protected $storedProcedure = 'spACOE_RptInventoryVoice';
    ...
    {
        $this->identify(false, self::CATEGORY_INVENTORY, 'Voice Inventory', 48);
    }
