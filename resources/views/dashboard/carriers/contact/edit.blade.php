...
@section('content')
    <div class="main-container" style="padding-bottom:0">
        <form style="margin:0" method="POST" action="{{ route('dashboard.carriers.contact.update', [$Carrier, $Contact ]) }}">
            {!! method_field('PUT') !!}
            <!-- start container -->
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <h2 class="common-heading">Update Contact</h2>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5 offset-md-1 col-6">
                                <a href="{{route('dashboard.carriers.show', [$Carrier])}}" class="btn-secondary">Cancel</a>
                            </div>
